...
window.APP_CONFIG = {
  ...
  // New staking
  STAKING5: "0xa960B32A137EfDE9c35f34C169EefeE6F4D5DD2d", // StakingV5

  // Legacy staking
  STAKING4: "0x4Dfa9EFEAc6069D139CF7ffEe406FAB78d7410A7", // StakingV4
  ...
  STAKING5_ABI: [
    ...
    { "inputs":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint256","name":"i","type":"uint256"}], "name":"stakeAt",
      "outputs":[{"components":[
        {"internalType":"uint8","name":"pkg","type":"uint8"},
    ...
    { "inputs":[{"internalType":"address","name":"user","type":"address"},{"internalType":"uint256","name":"stakeId","type":"uint256"}], "name":"pendingReward", "outputs":[{"internalType":"uint256","name":"","type":"uint256"}], "stateMutability":"view", "type":"function" },
    ...
    { "inputs":[], "name":"contractDFBalance", "outputs":[{"internalType":"uint256","name":"","type":"uint256"}], "stateMutability":"view", "type":"function" }
  ],
