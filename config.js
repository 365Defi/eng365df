...
window.APP_CONFIG = {
  ...
  STAKING_V4: "0x4Dfa9EFEAc6069D139CF7ffEe406FAB78d7410A7", // StakingV4 (legacy single-lot)
  STAKING_V5: "0xa960B32A137EfDE9c35f34C169EefeE6F4D5DD2d", // StakingV5 (multi-lot)
  ...
  // ===== StakingV5 ABI (ตาม ABI ที่คุณส่งมา) =====
  STAKING_V5_ABI: [
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Staking365V5.StakeLot",
          "name": "",
          "type": "tuple"
        }
      ],
